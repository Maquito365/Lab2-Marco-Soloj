...
public class MainLab2 {
    ...
    public static void main(String[] args) {
        ...
        // Solicita datos iniciales de jugadores y del tablero
            ...
            if (controlador.getTablero().FinJuego()) {
                ...
                if (respuesta.equalsIgnoreCase("s")) {
                    ...
                    scanner.nextLine(); // Consumir salto de línea pendiente
                                        // En vez de crear un nuevo controlador, reinicia el tablero y los puntos
                    controlador.nuevoJuego(n);
                    t = 1; // Reinicia el turno al jugador 1
                    continue;
                } else {
                    // Mostrar resultados finales y salir
                    System.out.println("\nResultados finales:");
                    System.out.println(controlador.getJugador1().getnombre() + " ganó " + controlador.getJugador1().getgamesGanados() + " partidas.");
                    System.out.println(controlador.getJugador2().getnombre() + " ganó " + controlador.getJugador2().getgamesGanados() + " partidas.");

                    if (controlador.getJugador1().getgamesGanados() > controlador.getJugador2().getgamesGanados()) {
                        System.out.println(controlador.getJugador1().getnombre() + " es el ganador general de la sesión.");
                    } else if (controlador.getJugador2().getgamesGanados() > controlador.getJugador1().getgamesGanados()) {
                        System.out.println(controlador.getJugador2().getnombre() + " es el ganador general de la sesión.");
                    } else {
                        System.out.println("La sesión finalizó en empate.");
                    }
                break;
                }
            }
